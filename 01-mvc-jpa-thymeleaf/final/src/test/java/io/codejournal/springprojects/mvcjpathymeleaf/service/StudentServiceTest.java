...
public class StudentServiceTest {
    ...
    @Test
    public void getStudent_ReturnsEmpty_WhenStudentDoesNotExist() {
    ...
    @Test
    public void save_ReturnsSaved_WhenStudentRecordIsCreated() {

        final UUID id = randomUUID();

        final Student expected = new Student(null, randomUUID().toString(), randomUUID().toString());
